            ...
            <div class="table-responsive p-0">
                  ...
                  <tbody>
                    ...
                    <td>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">{{ donation.created_at.split('T')[0] }}</span>
                      </td>
                      <td class="align-middle">
                        <Link :href="'/donations/' + donation.id" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          View
                        </Link>
                        |
                ...
                <ul class="pagination">
                    <li v-for="link, index in donations.links" :key="index">
                        <Link class="page-link " :class="{'active': link.active, 'disabled': link.url == null}" :href="`${link.url}`" v-html="link.label"></Link>
                    </li>
                </ul>
              </div>
        </Card>
