                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0">{{statistic.total_posts}}</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0"><span class="text-success text-sm font-weight-bolder">{{statistic.total_posts_last_week}}% </span>than last week
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-3" v-if="objectives.length">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <h6>My Calendar</h6>
                                    <vue-cal style="max-height: 400px;"
                                        hide-view-selector
                                        :time="false"
                                        active-view="month"
                                        xsmall>
