...
@section('content')
   ...
   <div class="flex">
    <div class="w-full md:w-1/2 p-2 h-screen overflow-y-auto">
        ...
        <div class="flex bg-white p-4 mt-4 rounded border-t-4 border-t-pink-500">
            ...
            <div class="px-4 w-2/3">
                ...
                <h2 class=" p-2 my-4">Descriptions: {{ \Str::limit($item->description, 20) }} <a href="/posts/{{$item->id}}" class="text-blue-500 underline">Read more</a></h2>
            </div>
        </div>
    @empty
