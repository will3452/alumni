<div  style="background: #800000" class="w-1/5 text-center h-screen hidden md:block text-white p-4 relative">
    ...
    <a href="/posts" class="block bg-pink-500 p-2 rounded text-pink-100 mb-4 relative w-full  z-10">
        Post News and Job Offers
    </a>
    <a href="/notifications" class="block bg-pink-500 p-2 rounded text-pink-100 mb-4 relative w-full  z-10">
        Notifications
    </a>
    <a href="{{route('coor.donations')}}" class="block bg-pink-500 p-2 rounded text-pink-100 mb-4 relative w-full  z-10">
        Donations
    </a>
    <a href="{{route('alumni.profile.show', ['user' => auth()->id()])}}" class="block bg-pink-500 p-2 rounded text-pink-100 mb-4 relative w-full  z-10">
        Profile
    </a>

    <img src="/sidebar.png" alt="" class="z-0 absolute bottom-0">
</div>